 ...
 */
public class Frag_Contactuni extends Fragment implements View.OnTouchListener {
    ...
    public Frag_Contactuni(){
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.frag_contectuni, container, false);
        ImageView view = (ImageView) v.findViewById(R.id.imageView7);
